        ...
        <>
            ...
            <main className='depositoContainer'>
                ...
                <section className='depositoSection'>
                    <DepositoItem title="DEPOSITO" img="../../../imgs/deposito/deposito.jpg" description="Nuestro depósito de 10,000 m² ofrece amplio espacio para almacenamiento eficiente. El piso tiene tratamiento geomanico garantizando seguridad en las operaciones, además de contar con todas las medidas de seguridad pertinentes" />
                    <DepositoItem title="GRUA PORTACONTENEDORES" img="../../../imgs/deposito/portacontenedores.jpg" description="Grúa especializada en operaciones de movimiento de contenedores, diseñada para garantizar eficiencia yseguridad en la manipulación precisa de carga en contextos logísticos variados" />
                    <DepositoItem title="GRUA HORQUILLA" img="../../../imgs/deposito/horquillas.jpg" description="Nuestras grúas de horquillas, con capacidad para levantar hasta 3 toneladas, ofrecen versatilidad y eficiencia en la manipulación de carga, optimizando operaciones logísticas" />
                    <DepositoItem title="GRUA VACÍOS" img="../../../imgs/deposito/gruaVacios.jpg" description="Grúas para la manipulación de unidades vacias dedicadas unicamente a estas operaciones, optimizando los tiempos de estadia de los camiones en depósito" />
